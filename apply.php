...
<div class="fixed w-full shadow-xl z-10">
  ...
  <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
    ...
    <div class="pt-20 min-w-screen min-h-screen bg-gray-900 flex items-center justify-center px-5 py-5">
        <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
            <div class="md:flex w-full">
                ...
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <?php if ($showSuccess) {
                        echo '<div class="p-2 flex justify-center mb-5" id="documentsAlert">
                    ...
                    <div class="text-center mb-10">
                        <h1 class="font-bold text-3xl text-gray-900">APPLY SCHOLARSHIP</h1>
                        <p>Enter your information to register</p>
                    </div>
                    <form method="POST" name="myForm">
                        <div class="mx-3">
                            <div class="w-full flex justify-center items-center px-3 mb-5">
                                <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 ml-2 sm:col-span-4 md:mr-3">
                                    <!-- Photo File Input -->
                                    <input type="file" name="AFront" id="AFront" class="hidden" x-ref="photo" x-on:change="
                                    ...
                                    <label class="block text-gray-700 text-sm font-bold mb-2 text-center" for="photo">
                                        AADHAR FRONT <strong style="color: red;">*</strong><span class="text-red-600"> </span>
                                    </label>
                                    
                                    <div class="text-center">
                                        <!-- Current Profile Photo -->
                                        <div class="mt-2 w-40 h-40 rounded-full shadow" x-show="! photoPreview"style="background-size: cover; background-repeat: no-repeat; background-position: center; background-image:url('https://media.istockphoto.com/vectors/young-annoyed-male-character-sceptical-face-expression-vector-id1252249411?k=20&m=1252249411&s=612x612&w=0&h=qlogUTVzsx-DCmeZ-TEK5IBMH9--zbsXh6iRX6w7JTE=');">
                                ...
                                <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 ml-2 sm:col-span-4 md:mr-3">
                                    <!-- Photo File Input -->
                                    <input type="file" class="hidden" name="ABack" id="ABack" x-ref="photo" x-on:change="
                                                        photoName = $refs.photo.files[0].name;
                                                        const reader = new FileReader();
                                                        reader.onload = (e) => {
                                                            photoPreview = e.target.result;
                                    ...
                                    <label class="block text-gray-700 text-sm font-bold mb-2 text-center" for="photo">
                                        AADHAR BACK <strong style="color: red;">*</strong> <span class="text-red-600"> </span>
                                    </label>
                                    
                                    <div class="text-center">
                                        <!-- Current Profile Photo -->
                                        <div class="mt-2 w-40 h-40 rounded-full shadow" style="background-size: cover; background-repeat: no-repeat; background-position: center; background-image:url('https://media.istockphoto.com/vectors/young-male-character-portrait-back-view-millennial-lifestyle-flat-vector-id1218868284?k=20&m=1218868284&s=612x612&w=0&h=U1N83cQM0FQcyPPcikBynLhgNE1ZEE8Z92erQUAsB4o=');" x-show="! photoPreview">
                                        </div>
                                        <!-- New Profile Photo Preview -->
                                        <div class="mt-2" x-show="photoPreview" style="display: none;">
                                            <span class="block w-40 h-40 rounded-full m-auto shadow" x-bind:style="'background-size: cover; background-repeat: no-repeat; background-position: center center; background-image: url(\'' + photoPreview + '\');'" style="background-size: cover; background-repeat: no-repeat; background-position: center center; background-image: url('null');">
                            ...
                            <div class="w-full px-3 mb-5">
                                ...
                                <label for="" class="text-xs font-semibold px-1">Full name <strong style="color: red;">*</strong></label>
                                <div class="flex">
                                    <div
                                    ...
                                    <input type="text" name="fname" id="fname"
                                        ...
                                        placeholder="Kishan" required>
                                </div>
                            </div>
                            <div>
                                <div class="w-full px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Email <strong style="color: red;">*</strong></label>
                                    <div class="flex">
                                        <div
                                            class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                        ...
                                        <input type="email" name="email" id="email"
                                            class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500"
                                            placeholder="kishan@example.com" required>
                                    </div>
                                </div>
                            </div>
                            <div>
                            ...
                            <div class="flex justify-center items-center" style="flex-wrap: wrap;">
                                <div class="px-3">
                                    <label for="" class="text-xs font-semibold px-1">Passport Size Photo <strong style="color: red;">*</strong></label>
                                     <div class="py-3 w-full">
                                      <label onclick="passport();" class="w-full flex cursor-pointer">
                                        <div id="passport" class="px-4 py-2 bg-blue-700 rounded-full font-semibold cursor-pointer text-sm text-white tracking-widest hover:bg-blue-800 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring focus:ring-blue-300 disabled:opacity-25 transition">
                                                Click to Upload
                                        </div>
                                        <input id="passportPhoto" name="passportPhoto" type='file' class="hidden" :multiple="multiple" :accept="accept" required />
                                      </label>
                                      <!-- <div id="passport"></div> -->
                                    </div>
                                </div>
                                ...
                                <div class="px-3">
                                    <label for="" class="text-xs font-semibold px-1">Admission Letter <strong style="color: red;">*</strong></label>
                                     <div class="py-3 w-full">
                                      <label onclick="admission();" class="w-full flex cursor-pointer">
                                        <div id="letter" class="px-4 py-2 bg-blue-700 rounded-full font-semibold cursor-pointer text-sm text-white tracking-widest hover:bg-blue-800 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring focus:ring-blue-300 disabled:opacity-25 transition">
                                                Click to Upload
                                        </div>
                                        <input id="addmissionLetter" name="addmissionLetter" type='file' class="hidden" :multiple="multiple" :accept="accept" required />
                                      </label>
                                    </div>
                                </div>

                                <div class="px-3">
                                    <label for="" class="text-xs font-semibold px-1">Fees Reciepts <strong style="color: red;">*</strong></label>
                                     <div class="py-3 w-full">
                                      <label onclick="fees();" class="w-full flex cursor-pointer">
                                        <div id="fees" class="px-4 py-2 bg-blue-700 rounded-full font-semibold cursor-pointer text-sm text-white tracking-widest hover:bg-blue-800 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring focus:ring-blue-300 disabled:opacity-25 transition">
                                                Click to Upload
                                        </div>
                                        <input id="feesReciepts" name="feesReciepts" type='file' class="hidden" :multiple="multiple" :accept="accept" required />
                                      </label>
                                    </div>
                                </div>

                                <div class="px-3">
                                    <label for="" class="text-xs font-semibold px-1">Income Certificate <strong style="color: red;">*</strong></label>
                                     <div class="py-3 w-full">
                                      <label onclick="income();" class="w-full flex cursor-pointer">
                                        <div id="income" class="px-4 py-2 bg-blue-700 rounded-full font-semibold cursor-pointer text-sm text-white tracking-widest hover:bg-blue-800 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring focus:ring-blue-300 disabled:opacity-25 transition">
                                                Click to Upload
                                        </div>
                                        <input id="incomeCertificate" name="incomeCertificate" type='file' class="hidden" :multiple="multiple" :accept="accept" required />
                                      </label>
                                    </div>
                                </div>

                                <div class="px-3">
                                    <label for="" class="text-xs font-semibold px-1">Passbook First Page <strong style="color: red;">*</strong></label>
                                     <div class="py-3 w-full">
                                      <label onclick="passbook();" class="w-full flex cursor-pointer">
                                        <div id="passbook" class="px-4 py-2 bg-blue-700 rounded-full font-semibold cursor-pointer text-sm text-white tracking-widest hover:bg-blue-800 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring focus:ring-blue-300 disabled:opacity-25 transition">
                                                Click to Upload
                                        </div>
                                        <input id="passbookFirstPage" name="passbookFirstPage" type='file' class="hidden" :multiple="multiple" :accept="accept" required />
                                      </label>
                                    </div>
                                </div>

                                <div class="px-3">
                                    <label for="" class="text-xs font-semibold px-1">ITR <strong style="color: red;">*</strong></label>
                                     <div class="py-3 w-full">
                                      <label onclick="ITR();" class="w-full flex cursor-pointer">
                                        <div id="ITR" class="px-4 py-2 bg-blue-700 rounded-full font-semibold cursor-pointer text-sm text-white tracking-widest hover:bg-blue-800 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring focus:ring-blue-300 disabled:opacity-25 transition">
                                                Click to Upload
                                        </div>
                                        <input id="itr" name="itr" type='file' class="hidden" :multiple="multiple" :accept="accept" required />
                                      </label>
                                    </div>
                                </div>

                                <div class="px-3">
                                    <label for="" class="text-xs font-semibold px-1">College Letter Pad <strong style="color: red;">*</strong></label>
                                     <div class="py-3 w-full">
                                      <label onclick="letterPad();" class="w-full flex cursor-pointer">
                                        <div id="letterPad" class="px-4 py-2 bg-blue-700 rounded-full font-semibold cursor-pointer text-sm text-white tracking-widest hover:bg-blue-800 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring focus:ring-blue-300 disabled:opacity-25 transition">
                                                Click to Upload
                                        </div>
                                        <input id="collegeLetterPad" name="collegeLetterPad" type='file' class="hidden" :multiple="multiple" :accept="accept" required />
                                      </label>
                                    </div>
                                </div>

                                <div class="px-3">
                                    <label for="" class="text-xs font-semibold px-1">Hostel Reciepts <strong style="color: red;">*</strong></label>
                                     <div class="py-3 w-full">
                                      <label onclick="rentOrHostel();" class="w-full flex cursor-pointer">
                                        <div id="rentOrHostel" class="px-4 py-2 bg-blue-700 rounded-full font-semibold cursor-pointer text-sm text-white tracking-widest hover:bg-blue-800 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring focus:ring-blue-300 disabled:opacity-25 transition">
                                                Click to Upload
                                        </div>
                                        <input id="hostelAndRent" name="hostelAndRent" type='file' class="hidden" :multiple="multiple" :accept="accept"  />
                                      </label>
                                    </div>
                                </div>

                                <div class="px-3 mb-5">
                                    <label for="" class="text-xs font-semibold px-1">Rent Agreement <strong style="color: red;">*</strong></label>
                                     <div class="py-3 w-full">
                                      <label onclick="rent();" class="w-full flex cursor-pointer">
                                        <div id="rent" class="px-4 py-2 bg-blue-700 rounded-full font-semibold cursor-pointer text-sm text-white tracking-widest hover:bg-blue-800 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring focus:ring-blue-300 disabled:opacity-25 transition">
                                                Click to Upload
                                        </div>
                                        <input id="rentAgreement" name="rentAgreement" type='file' class="hidden" :multiple="multiple" :accept="accept"  />
                                      </label>
                                    </div>
                                </div>
                            </div>
                                                        ...
                                                        <div style="display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                                            <p class="text-xs font-semibold px-1" ><strong style="color: red;">*</strong> Hostel Reciepts must be required if you live in hostel</p>
                                                            <p class="text-xs mb-6 font-semibold px-1"><strong style="color: red;">*</strong> Rent Agreement must be required if you live in rental house</p>
                                                        </div>
                            <div class="w-full px-3 mb-5">
                                <button type="submit" name="submit" id="submit" onclick="validate();"
                                    class="block w-full max-w-xs mx-auto bg-blue-700 hover:bg-blue-800 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">REGISTER
                                    NOW</button>
                            </div>
                        </div>
                    </form>
